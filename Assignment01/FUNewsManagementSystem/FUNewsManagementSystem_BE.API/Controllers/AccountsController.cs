...
using LoginRequest = FUNewsManagementSystem_FE.MVCWebApp.Models.LoginRequest;
...
namespace FUNewsManagementSystem_BE.API.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        [HttpPost("login")]
        public async Task<ActionResult<SystemAccount>> Login (LoginRequest loginRequest)
        {
