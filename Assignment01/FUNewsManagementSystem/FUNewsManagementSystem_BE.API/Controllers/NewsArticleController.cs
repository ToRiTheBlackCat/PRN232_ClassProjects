...
namespace FUNewsManagementSystem_BE.API.Controllers
{
    ...
    public class NewsArticleController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] FUNewsManagementSystem.Repository.Models.NewsArticle newsArticle)
        {
            if (newsArticle == null)
            {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] FUNewsManagementSystem.Repository.Models.NewsArticle newsArticle)
        {
            if (newsArticle == null)
            {
                return BadRequest("News article cannot be null.");
